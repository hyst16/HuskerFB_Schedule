...
if(tvp){ const tvi = document.createElement('img'); tvi.src = tvp; tvi.alt = next.tv_network.toUpperCase(); tvc.appendChild(tvi); }
...
const oimg2 = document.createElement('img'); oimg2.alt=g.opponent_name||'Opponent'; oimg2.src = opponentLogo(g.opponent_slug) || './tv/opponent.svg';
...
if(tl){ const tvi2 = document.createElement('img'); tvi2.src = tl; tvi2.alt=g.tv_network.toUpperCase(); tvcell.appendChild(tvi2); }
else { tvcell.textContent = 'TBA'; tvcell.style.color = '#cbd5e1'; tvcell.style.fontWeight='700'; }
